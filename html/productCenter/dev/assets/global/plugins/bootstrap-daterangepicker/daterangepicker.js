...
(function (root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        updateCalendars: function () {
            ...
            console.log("this.startDate.format: " + this.startDate.format('YYYY-MM-DD') + ", this.endDate.format: " + this.endDate.format('YYYY-MM-DD'));
            for (var range in this.ranges) {
                console.log("this.ranges[range][0].format: " + this.ranges[range][0].format('YYYY-MM-DD')
                    + ", this.ranges[range][1].format: " + this.ranges[range][1].format('YYYY-MM-DD'));
