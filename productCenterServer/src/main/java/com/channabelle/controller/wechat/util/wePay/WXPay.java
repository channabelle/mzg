...
public class WXPay {
    Logger log = Logger.getLogger(WXPay.class);
    ...
    public boolean isPayResultNotifySignatureValid(Map<String, Object> reqData) throws Exception {
        String signTypeInData = String.valueOf(reqData.get(WXPayConstants.FIELD_SIGN_TYPE));
        SignType signType;
     ...
     * @throws Exception
     */
    public String requestWithoutCert(String urlSuffix, Map<String, Object> reqData, int connectTimeoutMs,
                                     int readTimeoutMs) throws Exception {
        String msgUUID = String.valueOf(reqData.get("nonce_str"));
     ...
     * @throws Exception
     */
    public String requestWithCert(String urlSuffix, Map<String, Object> reqData, int connectTimeoutMs,
                                  int readTimeoutMs) throws Exception {
        String msgUUID = String.valueOf(reqData.get("nonce_str"));
        String reqBody = WXPayUtil.mapToXml(reqData);
    ...
    public Map<String, Object> processResponseXml(String xmlStr) throws Exception {
        ...
        if(respData.containsKey(RETURN_CODE)) {
            return_code = String.valueOf(respData.get(RETURN_CODE));
        } else {
     ...
     * @throws Exception
     */
    public Map<String, Object> microPay(Map<String, Object> reqData, int connectTimeoutMs, int readTimeoutMs)
            throws Exception {
        String url;
        if(this.useSandbox) {
        ...
        while(true) {
            ...
            if(readTimeoutMs > 1000) {
                try {
                    ...
                    String returnCode = String.valueOf(lastResult.get("return_code"));
                    if(returnCode.equals("SUCCESS")) {
                        String resultCode = String.valueOf(lastResult.get("result_code"));
                        String errCode = String.valueOf(lastResult.get("err_code"));
     ...
     * @throws Exception
     */
    public Map<String, Object> unifiedOrder(Map<String, Object> reqData, int connectTimeoutMs, int readTimeoutMs)
            throws Exception {
        String url;
        if(this.useSandbox) {
     ...
     * @throws Exception
     */
    public Map<String, Object> orderQuery(Map<String, Object> reqData, int connectTimeoutMs, int readTimeoutMs)
            throws Exception {
        String url;
        if(this.useSandbox) {
     ...
     * @throws Exception
     */
    public Map<String, Object> reverse(Map<String, Object> reqData, int connectTimeoutMs, int readTimeoutMs)
            throws Exception {
        String url;
        if(this.useSandbox) {
     ...
     * @throws Exception
     */
    public Map<String, Object> closeOrder(Map<String, Object> reqData, int connectTimeoutMs, int readTimeoutMs)
            throws Exception {
        String url;
        if(this.useSandbox) {
     ...
     * @throws Exception
     */
    public Map<String, Object> refund(Map<String, Object> reqData, int connectTimeoutMs, int readTimeoutMs)
            throws Exception {
        String url;
        if(this.useSandbox) {
     ...
     * @throws Exception
     */
    public Map<String, Object> refundQuery(Map<String, Object> reqData, int connectTimeoutMs, int readTimeoutMs)
            throws Exception {
        String url;
        if(this.useSandbox) {
     ...
     * @throws Exception
     */
    public Map<String, Object> downloadBill(Map<String, Object> reqData, int connectTimeoutMs, int readTimeoutMs)
            throws Exception {
        String url;
        if(this.useSandbox) {
     ...
     * @throws Exception
     */
    public Map<String, Object> report(Map<String, Object> reqData, int connectTimeoutMs, int readTimeoutMs)
            throws Exception {
        String url;
        if(this.useSandbox) {
     ...
     * @throws Exception
     */
    public Map<String, Object> shortUrl(Map<String, Object> reqData, int connectTimeoutMs, int readTimeoutMs)
            throws Exception {
        String url;
        if(this.useSandbox) {
     ...
     * @throws Exception
     */
    public Map<String, Object> authCodeToOpenid(Map<String, Object> reqData, int connectTimeoutMs, int readTimeoutMs)
            throws Exception {
        String url;
        if(this.useSandbox) {
