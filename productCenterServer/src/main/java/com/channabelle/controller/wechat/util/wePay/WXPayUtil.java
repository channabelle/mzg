...
public class WXPayUtil {
    private static Logger log = Logger.getLogger(WXPayRequest.class);
    ...
    public static Map<String, Object> xmlToMap(String strXML) throws Exception {
        try {
            ...
            WXPayUtil.getLogger().warn("Invalid XML, can not convert to map. Error message: " + ex.getMessage() + ", XML content: " + strXML, ex);
            throw ex;
        }
     ...
     * @return 含有sign字段的XML
     */
    public static String generateSignedXml(final Map<String, Object> data, String key, SignType signType)
            throws Exception {
    ...
    public static boolean isSignatureValid(String xmlStr, String key) throws Exception {
        ...
        String sign = String.valueOf(data.get(WXPayConstants.FIELD_SIGN));
    ...
    public static String generateSignature(final Map<String, Object> data, String key, SignType signType)
        ...
        for(String k : keyArray) {
            ...
            if(null != data.get(k) && String.valueOf(data.get(k)).trim().length() > 0) {
                // 参数值为空，则不参与签名
    ...
    public static Logger getLogger() {
        Logger logger = Logger.getLogger(WXPayUtil.class);
        return logger;
    }
